    ...
    <div class="pop_mid">
        ...
        <div class="pop_stn">
            ...
            <div class="pop_stn_cont">
                <dl class="dlBox">
                    <dt>사이트 명</dt>
                    <dd><input type="text" class="ipt_txt" id="site_name" name="site_name" value=""></dd>
                </dl>
                <dl class="dlBox">
                    <dt>최대 미팅룸</dt>
                    <dd><input type="number"  class="ipt_txt" id="max_meeting_room_cnt" name="max_meeting_room_cnt" value=""></dd>
                </dl>
                <dl class="dlBox">
                    <dt>최대 마이크</dt>
                    <dd><input type="number" class="ipt_txt" id="max_mic_cnt" name="max_mic_cnt" value=""></dd>
                </dl>
                <dl class="dlBox">
                    <dt>모델정보 설명</dt>
                    <dd>
