...
회의현황/상세보기.회의룸 일련번호 : ${frontConfVO.room_ser}
<p>&nbsp;</p>
...
<div class="div_normal">
    ...
    <c:choose>
        <c:when test="${fn:length(detailViewList) gt 0}">
            <c:forEach items="${detailViewList}" var="dvList" varStatus="status">
                <div class="row">
                    <div class="cell">${dvList.minutes_name}</div>
                    <div class="cell">${dvList.meetingroom_name}</div>
                    <div class="cell">
                        <span class="field-tip">
                            ${dvList.minutes_joined_cnt} <img src="/img/icon_magnifier.jpg" width="15px" height="15px">
                            <span class="tip-content">${dvList.minutes_joined_mem}</span>
                        </span>
                    </div>
                    <div class="cell">${dvList.minutes_start_date}</div>
                    <div class="cell">${dvList.rec_start_time}</div>
                    <div class="cell">${dvList.rec_end_time}</div>
                    <div class="cell">${dvList.rec_time}</div>
                    <div class="cell">
                        <input type="button" value="재생" onclick="goScriptView('${dvList.stt_meta_ser}', 'RT');">
                        /
                        <input type="button" value="편집" onclick="goScriptView('${dvList.stt_meta_ser}', 'REC');">
                    </div>
