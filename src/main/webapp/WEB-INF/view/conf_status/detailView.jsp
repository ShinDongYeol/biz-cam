...
<script type="text/javascript">
    ...
    /*   function makeParam() {
           ...
           var joined = $('#joinedMem').val();
           var memo = $('#confMemo').val();
           var others =$('#other').val();

           var startDate = $( ".fromDate" ).datepicker({ dateFormat: 'yy-mm-dd' }).val();
           var endDate = $( ".toDate").datepicker({ dateFormat: 'yy-mm-dd' }).val();
